...
\@x{ {\CONSTANTS} N ,\, FAILNUM}%
 \@x{ {\ASSUME} N \.{\leq} 5 \.{\land} 0 \.{\leq} FAILNUM \.{\land} FAILNUM
 \.{\leq} 4}%
\@x{ Nodes \.{\defeq} 1 \.{\dotdot} N}%
\@x{ Process \.{\defeq} 1 \.{\dotdot} N}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} syncCon2}%
\@x{ {\p@lbrace} {\p@variables} FailNum \.{=} FAILNUM {\p@semicolon}}%
 \@x{\@s{14.08} up \.{=} [ n \.{\in} Nodes \.{\mapsto} {\TRUE} ]
 {\p@semicolon}}%
 \@x{\@s{14.08} pt\@s{1.72} \.{=} [ n \.{\in} Nodes \.{\mapsto} 0 ]
 {\p@semicolon}}%
 \@x{\@s{14.08} t\@s{1.87} \.{=} [ n \.{\in} Nodes \.{\mapsto} {\FALSE} ]
 {\p@semicolon}}%
 \@x{\@s{14.08} d \.{=} [ n \.{\in} Nodes \.{\mapsto} \.{-} 1 ]
 {\p@semicolon}}%
\@x{\@s{14.08} mb \.{=} [ n \.{\in} Nodes \.{\mapsto} \{ \} ] {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{14.08} {\p@define} {\p@lbrace}}%
 \@x{\@s{14.08} SetMin ( S ) \.{\defeq} {\CHOOSE} i \.{\in} S \.{:} \A\, j
 \.{\in} S \.{:} i \.{\leq} j}%
\@x{\@s{14.08} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{14.08} {\p@macro} MaybeFail {\p@lparen} {\p@rparen} {\p@lbrace}}%
 \@x{\@s{22.28} {\p@if} {\p@lparen} FailNum \.{>} 0 \.{\land} up [ self ]
 {\p@rparen}}%
\@x{\@s{32.82} {\p@lbrace} {\p@either}}%
 \@x{\@s{46.51} {\p@lbrace} up [ self ] \.{:=} {\FALSE} {\p@semicolon} FailNum
 \.{:=} FailNum \.{-} 1 {\p@semicolon} {\p@rbrace}}%
\@x{\@s{56.09} {\p@or} {\p@skip} {\p@semicolon} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{14.08} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{14.08} {\p@fair} {\p@process} {\p@lparen} n \.{\in} Process
 {\p@rparen}}%
\@x{\@s{14.08} {\p@variable} v \.{=} 0 ,\, Q \.{=} \{ \} {\p@semicolon}}%
\@x{\@s{14.08} {\p@lbrace}}%
 \@x{ P\@s{.5}\textrm{:}\@s{3} {\p@await} ( up [ self ] \.{\land} \A\, s
 \.{\in} Nodes \.{:} mb [ s ] \.{=} \{ \} \.{\land} ( \A\, i \.{\in} Nodes
 \.{:} pt [ i ] \.{=} pt [ self ] ) \.{\land} t [ self ] \.{=} {\FALSE} )
 {\p@semicolon} {\p@lbrace}}%
 \@x{\@s{14.08} {\p@if} {\p@lparen} pt [ self ] \.{=} 0 {\p@rparen} v \.{:=}
 self {\p@semicolon}}%
\@y{%
 If in round 0, each node broadcast its own value
}%
\@xx{}%
\@x{\@s{14.08} {\p@else} v \.{:=} d [ self ] {\p@semicolon}}%
\@y{%
 If in other round, each node broadcast the minimum value it received.
}%
\@xx{}%
\@x{\@s{14.08} Q \.{:=} Nodes {\p@semicolon}}%
\@y{%
 Broadcast value to \ensuremath{Nodes}, if one node is crashed, we
 needn\mbox{'}t broad value to it.
}%
\@xx{}%
 \@x{ PS\@s{.5}\textrm{:}\@s{3}\@s{0.86} {\p@while} {\p@lparen} up [ self ]
 \.{\land} Q \.{\neq} \{ \} {\p@rparen} {\p@lbrace}}%
\@x{\@s{28.94} {\p@with} {\p@lparen} p \.{\in} Q {\p@rparen} {\p@lbrace}}%
\@x{\@s{37.14} MaybeFail ( ) {\p@semicolon}}%
\@y{%
 In process \ensuremath{n}, each time we add \ensuremath{v} to
 \ensuremath{mb[p]}, this process might be fail, and once the process
}%
\@xx{}%
\@x{\@s{99.01}}%
\@y{%
 fail, we set \ensuremath{up[self]} fail and after that, all operations will
 be invalid.
}%
\@xx{}%
\@x{\@s{37.14} {\p@if} {\p@lparen} up [ self ] \.{=} {\TRUE} {\p@rparen}}%
\@y{%
 Test if operations have been failed before
}%
\@xx{}%
\@x{\@s{47.68} mb [ p ] \.{:=} mb [ p ] \.{\cup} \{ v \} {\p@semicolon}}%
\@y{%
 In process \ensuremath{n}, add \ensuremath{v} to \ensuremath{mb[1]} to
 \ensuremath{mb[N]
}}%
\@xx{}%
\@x{\@s{37.14} Q \.{:=} Q \.{\,\backslash\,} \{ p \} {\p@semicolon}}%
\@y{%
 For each element \ensuremath{p} in \ensuremath{Q}, we have to broadcast
 value \ensuremath{v} to \ensuremath{mb[p]}, after adding \ensuremath{v} to
 \ensuremath{mb[p]},
}%
\@xx{}%
\@x{\@s{103.48}}%
\@y{%
 remove \ensuremath{p} from \ensuremath{Q} in case of adding \ensuremath{v}
 to \ensuremath{mb[p]} again.
}%
\@xx{}%
\@x{\@s{28.94} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{20.74} {\p@rbrace} {\p@semicolon}}%
 \@x{\@s{20.74} {\p@if} {\p@lparen} up [ self ] {\p@rparen} pt [ self ] \.{:=}
 pt [ self ] \.{+} 1 {\p@semicolon}}%
 \@x{\@s{20.74} {\p@if} {\p@lparen} up [ self ] \.{=} {\FALSE} {\p@rparen}
 Nodes \.{:=} Nodes \.{\,\backslash\,} \{ self \} {\p@semicolon}}%
\@y{%
 If this process crashed, remove this node from nodes
}%
\@xx{}%
 \@x{ PR\@s{.5}\textrm{:}\@s{3} {\p@await} ( up [ self ] \.{\land} ( \A\, i
 \.{\in} Nodes \.{:} pt [ i ] \.{=} pt [ self ] ) ) {\p@semicolon}}%
\@y{%
 Wait until all process finished
}%
\@xx{}%
\@x{\@s{20.74} d [ self ] \.{:=} SetMin ( mb [ self ] ) {\p@semicolon}}%
\@x{\@s{20.74} mb [ self ] \.{:=} \{ \} {\p@semicolon}}%
\@y{%
 The mailbox should be empty before every round begin.
}%
\@xx{}%
 \@x{\@s{20.74} {\p@if} {\p@lparen} \A\, i \.{\in} Nodes \.{:} d [ self ]
 \.{=} d [ i ] {\p@rparen} {\p@lbrace}}%
\@x{\@s{35.38} t [ self ] \.{:=} {\TRUE} {\p@semicolon}}%
\@y{%
 If all \ensuremath{d[i]} in \ensuremath{Nodes} are the same, the result
}%
\@xx{}%
\@x{\@s{110.11}}%
\@y{%
...
\@xx{}%
\@x{\@s{20.74} {\p@rbrace}}%
\@x{\@s{20.74} {\p@else} {\p@goto} P {\p@semicolon}}%
\@y{%
 If some \ensuremath{d[i]} in \ensuremath{Nodes} is different, some nodes
 must be crashed, so go to the next round.
}%
\@xx{}%
\@x{\@s{14.08} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{4.1} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
\@xx{}%
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} v\@s{2.93} \.{=} [ self \.{\in} Process \.{\mapsto}
 0 ]}%
\@x{\@s{35.70} \.{\land} Q \.{=} [ self \.{\in} Process \.{\mapsto} \{ \} ]}%
\@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto}\@w{P} ]}%
\@pvspace{8.0pt}%
\@x{ P ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P}}%
 \@x{\@s{50.90} \.{\land} ( up [ self ] \.{\land} \A\, s \.{\in} Nodes \.{:}
 mb [ s ] \.{=} \{ \} \.{\land} ( \A\, i \.{\in} Nodes \.{:} pt [ i ] \.{=}
 pt [ self ] ) \.{\land} t [ self ] \.{=} {\FALSE} )}%
\@x{\@s{50.90} \.{\land} {\IF} pt [ self ] \.{=} 0}%
 \@x{\@s{74.17} \.{\THEN} \.{\land} v \.{'} \.{=} [ v {\EXCEPT} {\bang} [ self
 ] \.{=} self ]}%
 \@x{\@s{74.17} \.{\ELSE} \.{\land} v \.{'} \.{=} [ v {\EXCEPT} {\bang} [ self
 ] \.{=} d [ self ] ]}%
 \@x{\@s{50.90} \.{\land} Q \.{'} \.{=} [ Q {\EXCEPT} {\bang} [ self ] \.{=}
 Nodes ]}%
...
\@x{\@s{131.44} \.{\land} {\IF} up \.{'} [ self ] \.{=} {\TRUE}}%
 \@x{\@s{154.71} \.{\THEN} \.{\land} mb \.{'} \.{=} [ mb {\EXCEPT} {\bang} [ p
 ] \.{=} mb [ p ] \.{\cup} \{ v [ self ] \} ]}%
\@x{\@s{154.71} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{186.02} \.{\land} mb \.{'} \.{=} mb}%
...
\@x{\@s{112.13} \.{\land} {\IF} up [ self ] \.{=} {\FALSE}}%
 \@x{\@s{135.40} \.{\THEN} \.{\land} Nodes \.{'} \.{=} Nodes
 \.{\,\backslash\,} \{ self \}}%
\@x{\@s{135.40} \.{\ELSE} \.{\land} {\TRUE}}%
 \@x{\@s{112.13} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{PR} ]}%
 ...
 {\rangle}}%
\@x{\@s{57.56} \.{\land} {\UNCHANGED} {\langle} t ,\, d ,\, v {\rangle}}%
\@pvspace{8.0pt}%
\@x{ PR ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{PR}}%
 \@x{\@s{57.56} \.{\land} ( up [ self ] \.{\land} ( \A\, i \.{\in} Nodes \.{:}
 pt [ i ] \.{=} pt [ self ] ) )}%
 \@x{\@s{57.56} \.{\land} d \.{'} \.{=} [ d {\EXCEPT} {\bang} [ self ] \.{=}
 SetMin ( mb [ self ] ) ]}%
 \@x{\@s{57.56} \.{\land} mb \.{'} \.{=} [ mb {\EXCEPT} {\bang} [ self ] \.{=}
 \{ \} ]}%
 \@x{\@s{57.56} \.{\land} {\IF} \A\, i \.{\in} Nodes \.{:} d \.{'} [ self ]
 \.{=} d \.{'} [ i ]}%
 \@x{\@s{80.82} \.{\THEN} \.{\land} t \.{'} \.{=} [ t {\EXCEPT} {\bang} [ self
 ] \.{=} {\TRUE} ]}%
 \@x{\@s{112.13} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
 \@x{\@s{80.82} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{P} ]}%
\@x{\@s{112.13} \.{\land} t \.{'} \.{=} t}%
 \@x{\@s{57.56} \.{\land} {\UNCHANGED} {\langle} FailNum ,\, up ,\, pt ,\, v
 ,\, Q {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ n ( self ) \.{\defeq} P ( self ) \.{\lor} PS ( self ) \.{\lor} PR ( self
 )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} Process \.{:} n ( self ) )}%
\@x{\@s{47.82} \.{\lor}}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 ...
 vars}}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} Process \.{:} {\WF}_{ vars} ( n (
 self ) )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ agreement \.{\defeq} ( \A\, i ,\, j \.{\in} Nodes \.{:} t [ i ]
 \.{\land} t [ j ] \.{\implies} d [ i ] \.{=} d [ j ] )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 24 21:28:08 \ensuremath{EDT} 2017 by \ensuremath{lenovo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Oct} 24
 00:19:48 \ensuremath{EDT} 2017 by \ensuremath{lenovo
}%
\end{cpar}%
\end{lcom}%
\end{document}
