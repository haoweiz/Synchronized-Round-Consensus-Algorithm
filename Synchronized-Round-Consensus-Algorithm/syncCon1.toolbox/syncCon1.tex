...
\@x{\@s{14.08} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{14.08} {\p@fair} {\p@process} {\p@lparen} n \.{\in} Nodes
 {\p@rparen}}%
\@x{\@s{14.08} {\p@variable} v \.{=} 0 ,\, Q \.{=} \{ \} {\p@semicolon}}%
\@x{\@s{14.08} {\p@lbrace}}%
 \@x{ P\@s{.5}\textrm{:}\@s{3} {\p@if} {\p@lparen} up [ self ] {\p@rparen}
 {\p@lbrace}}%
\@x{\@s{14.08} v\@s{2.93} \.{:=} self {\p@semicolon}}%
...
\@xx{}%
 \@x{\@s{37.14} {\p@if} {\p@lparen} up [ self ] {\p@rparen} mb [ p ] \.{:=} mb
 [ p ] \.{\cup} \{ v \} {\p@semicolon}}%
\@y{%
...
\@y{%
 If no operations are failed and all process enter in round 1
}%
\@xx{}%
\@x{\@s{20.74} d [ self ] \.{:=} SetMin ( mb [ self ] ) {\p@semicolon}}%
\@y{%
 Set the minimum of \ensuremath{mb[p]} to \ensuremath{d[self]}, if success,
 all \ensuremath{d[p]} will be the same.
}%
\@xx{}%
\@x{\@s{20.74} t [ self ]\@s{1.87} \.{:=} {\TRUE} {\p@semicolon}}%
\@y{%
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} v\@s{2.93} \.{=} [ self \.{\in} Nodes \.{\mapsto} 0
 ]}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*When no crash happened, the program will
 excute without any problems and all \ensuremath{d[i]
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*will be the same. However, if some nodes
 crash, the crashed process will be in round \ensuremath{0
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*and other uncrashed processes will be in
 round 1, so other uncrashed processes will
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*not execute \ensuremath{SetMin(S)}, so all
 \ensuremath{d[i]} will be \ensuremath{\.{-}1}. Only if all processes are not
 crashed can
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}*we get minimum value.
\end{cpar}%
\vshade{15.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 24 21:46:27 \ensuremath{EDT} 2017 by \ensuremath{lenovo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Oct} 11
 00:01:22 \ensuremath{EDT} 2017 by \ensuremath{lenovo
}%
\end{cpar}%
\end{lcom}%
\end{document}
